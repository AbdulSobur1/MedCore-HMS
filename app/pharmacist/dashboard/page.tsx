...
export default function PharmacistDashboard() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
      ...
      <h1 className="text-2xl font-semibold text-[--text-1] mb-2">Pharmacist Dashboard</h1>
      <p className="text-sm text-[--text-3] max-w-md">
        This module is coming soon. You&apos;ll be able to manage prescriptions, track inventory, and handle dispensing here.
      </p>
