    ...
    <div className="space-y-6">
      ...
      {showAdd && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="fixed inset-0 lg:left-[220px] bg-black/30" onClick={() => setShowAdd(false)} />
      ...
      {showEdit && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="fixed inset-0 lg:left-[220px] bg-black/30" onClick={() => setShowEdit(null)} />
          <div className="relative bg-[--surface] rounded-xl border border-[--border] p-6 w-full max-w-md">
